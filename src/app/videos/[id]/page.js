        ...
        <div key={key} className="flex flex-col justify-between p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-[#191919] dark:border-stone-700">
            ...
            <div>
                ...
                {(item.attachments.length > 0) ?
                    <span>
                        <Link href={`/videos/${params.id}/${item.id}`} download className="flex justify-between mt-2 w-full items-center px-3 py-2 text-sm font-medium text-center text-white bg-lime-700 rounded-lg hover:bg-lime-800">
                            <span> فتح</span>
                        </Link>
                    </span>
                    : ""
